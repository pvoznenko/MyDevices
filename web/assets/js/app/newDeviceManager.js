 ...
 *
 * Required libraries: jquery.js, jquery.cookie.js, bootstrap.js, fingerprint.js, browser.js, require.js
 */
define(['jquery', 'fingerprint', 'browser', 'jqueryCookie', 'bootstrap'], function($, Fingerprint){
    "use strict";
